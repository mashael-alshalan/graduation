...
class _addsectionState extends State<editsection>  {
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: TextField(
              decoration: InputDecoration(
                icon: Icon(Icons.class__outlined,color: Colors.grey[300],),
                hintText: "Course ID",
          ...
          Container(
            ...
            child: TextField(
              decoration: InputDecoration(
                icon: Icon(Icons.location_pin,color: Colors.grey[300],),
                hintText: "Location",
                border: InputBorder.none,
              ),
              onTap: (){
