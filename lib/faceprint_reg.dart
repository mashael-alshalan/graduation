...
class faceprint_rej extends StatefulWidget {
  const faceprint_rej({Key? key}) : super(key: key);

  @override
  _faceprintState createState() => _faceprintState();
}

class _faceprintState extends State<faceprint_rej> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 30,),
            Text("Register using your Face ID",
              style: TextStyle(
                color: Colors.grey,
                fontSize: 12.0,
                fontWeight: FontWeight.bold,
