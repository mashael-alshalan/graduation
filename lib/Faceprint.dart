...
class faceprint extends StatefulWidget {
  const faceprint({Key? key}) : super(key: key);

  @override
  _faceprintState createState() => _faceprintState();
}

class _faceprintState extends State<faceprint> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: 30,),
            Text("Authenticate using your Face ID insted of your voice",
              style: TextStyle(
                color: Colors.grey,
                fontSize: 12.0,
                fontWeight: FontWeight.bold,
